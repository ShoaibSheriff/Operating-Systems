...
#include <linux/bkpfs/bkpfs_common.h>

// #define EXTRA_CREDIT 20
...
#define BKP_FOLDER_PREFIX ".bak."

/* Maximum number of backups */
#define MAX_SUPPORTED 10000

/* Attribute key */
#define BKP_ATTRIBUTE_KEY "user.bkpfs.bkpfolder_xattrs"
...
struct bkpfs_global_meta_data {
	u16 max_backup_version;
	int max_size_kb;
};
